...
<title>Acer Iconia Tab A1-810</title>
...
<div id="NBarang">Acer Iconia Tab A1-810</div>
<div id="GBarang"><img src="../../image/Acer Iconia Tab A1-810.png" width="226" height="213" /></div>
<div id="InfoBarang">
  <p>SIM: -</p>
  <p>Dimensi: 208.7 x 145.7 x 11.1 mm</p>
  <p>Berat: 410 g</p>
  <p>Ukuran Layar: 768x1024 pixels</p>
  <p>Memori: microSD up to 32 GB, internal 16 GB 1 GB RAM</p>
  <p>Kamera: 5 MP, 2592x1944 (belakang) VGA (depan)</p>
  <p>OS: Android OS v4.2 (Jelly Bean)</p>
  <p>CPU: Quad-core 1.2 GHz </p>
  <p>Harga: 16000</p>
</div>
<div id="BeliBarang">
<form id="belit4" name="belit4" method="post" action="" >
		<input type="submit" name="BeliTablet4" id="BeliTablet4" value="Beli" />
  </form>
  </div>
</body>
</html>
