		...
		<tr>
			<td>
				<a href="index.php?page=barang&nama=2tang_botol">
				<img src="images/Minuman/air mineral/2tang botol.jpg" alt="2tang botol" width="200"/></a>
			</td>
			<td>
				<a href="index.php?page=barang&nama=ades_botol">
				<img src="images/Minuman/air mineral/ades botol.jpg" alt="ades botol" width="100"/></a>
			</td>
			<td>
				<a href="index.php?page=barang&nama=aqua_botol">
				<img src="images/Minuman/air mineral/aqua botol.jpg" alt="aqua botol" width="200"/></a>
			</td>
			<td>
				<a href="index.php?page=barang&nama=aqua_galon">
				<img src="images/Minuman/air mineral/Aqua Galon.jpg" alt="Aqua Galon" width="100"/></a>
			</td>
		</tr>
		<tr>
			<td>
				<a href="index.php?page=barang&nama=aqua_gelas">
				<img src="images/Minuman/air mineral/aqua gelas.jpg" alt="aqua gelas" width="200"/></a>
			</td>
			<td>
				<a href="index.php?page=barang&nama=cleo_galon">
				<img src="images/Minuman/air mineral/cleo galon.jpg" alt="cleo galon" width="200"/></a>
			</td>
			<td>
				<a href="index.php?page=barang&nama=mizone_leci_botol">
				<img src="images/Minuman/air mineral/mizone leci botol.jpg" alt="mizone leci botol" width="200"/></a>
			</td>
			<td>
				<a href="index.php?page=barang&nama=nestle_botol">
				<img src="images/Minuman/air mineral/nestle botol.jpg" alt="nestle botol" width="200"/></a>
			</td>
		</tr>
		</table>
		</div>
		...
		<tr>
			<td>
				<a href="index.php?page=barang&nama=kopi_abc_mocca">
				<img src="images/Minuman/kopi/abc-kopi-mocca-bag-27grx30.jpg" alt="kopi abc mocca" width="200"/></a>
			</td>
			<td>
				<a href="index.php?page=barang&nama=goodday_cappucino">
				<img src="images/Minuman/kopi/good-day-cappucinno-bag-750gr.jpg" alt="goodday cappucino" width="200"/></a>
			</td>
			<td>
				<a href="index.php?page=barang&nama=indocafe_cappucino">
				<img src="images/Minuman/kopi/indocafe-cappucino-25-gr-x-50.jpg" alt="kopi indocafe capucino" width="200"/></a>
			</td>
			<td>
				<a href="index.php?page=barang&nama=indocafe_coffe_mix">
				<img src="images/Minuman/kopi/indocafe-coffee-mix-20-gr-x-100.jpg" alt="indocafe-coffee-mix-20-gr-x-100" width="200"/></a>
			</td>
		</tr>
		<tr>
			<td>
				<a href="index.php?page=barang&nama=kopiko_brown_coffe">
				<img src="images/Minuman/kopi/kopiko-brown-coffee-bag-30sach-x-25-gr.jpg" alt="kopiko brown coffe" width="200"/></a>
			</td>
			<td>
				<a href="index.php?page=barang&nama=miwon_ginseng">
				<img src="images/Minuman/kopi/miwon-kopi-ginseng-20-gr-x-20.jpg" alt="kopi gingseng" width="200"/></a>
			</td>
			<td>
				<a href="index.php?page=barang&nama=nescafe_3in1">
				<img src="images/Minuman/kopi/nescafe-3in1-original.jpg" alt="kopi 3 in 1" width="200"/></a>
			</td>
			<td>
				<a href="index.php?page=barang&nama=singa_robusta">
				<img src="images/Minuman/kopi/singa-kopi-robusta-360g.jpg" alt="kopi-robusta" width="200"/></a>
			</td>
		</tr>
		</table>
		</div>
		...
		<tr>
			<td>
				<a href="index.php?page=barang&nama=abc_sirsak">
				<img src="images/Minuman/sari buah/abc sirsak.jpg" alt="abc sirsak" width="200"/></a>
			</td>
			<td>
				<a href="index.php?page=barang&nama=buavita_jeruk">
				<img src="images/Minuman/sari buah/buavita jeruk.jpg" alt="buavita jeruk" width="200"/></a>
			</td>
			<td>
				<a href="index.php?page=barang&nama=buavita_sirsak">
