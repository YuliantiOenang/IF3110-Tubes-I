			...
			<?php
				...
				while($row = mysqli_fetch_array($result)){
					...
					echo "<div class='goods'>"	;
						...
						?>
							<form>
							<div id='quantity' ><input type='text' name='quant' id = "quant" value='0' size=7 ></input><br/></div>

							<div id='cart'><a><img src="../img/addtocart.png" height=25px onmouseup="addToCart(quant.value, <?php echo $row['id_inventori']; ?>)"></a></div>
