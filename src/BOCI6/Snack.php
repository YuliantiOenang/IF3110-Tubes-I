...
<body>
	...
	<div id="container">
		...
		<div id="sort-bar" class="frame">
			...
			<button type="button" onClick="location.href='Snack.php?SortBy=Nama'">Nama</button>
			<button type="button" onClick="location.href='Snack.php?SortBy=Harga'">Harga</button>
		</div>
