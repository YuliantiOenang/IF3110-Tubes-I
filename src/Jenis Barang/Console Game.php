...
<div id="SearchBar">
  ...
  <input type="submit" name="T.Search" id="T.Search" value="Cari Barang!" />
	...
	<div id='KBarang'>Console Game</div>
    
<?php
	$query = "SELECT `id`, `nama`, `harga`, `stok`, `terjual` FROM `console game` ORDER BY `id`";
    ...
    <div id='NBarang$id'><a href='Console Game/Console$id.php'>$nama</a></div>
    <div id='HBarang$id'>Rp$harga</div>
    <div id='BBarang1'>
    <form id='belit1' name='belit1' method='post' action='' >
            <input type='submit' name='BeliConsole Game1' id='BeliConsole Game1' value='Beli' />
      </form>
    </div>
    
    <div id='BBarang2'>
        <form id='belit2' name='belit2' method='post' action='' >
            <input type='submit' name='BeliConsole Game2' id='BeliConsole Game2' value='Beli' />
      </form>
    </div>
    
    <div id='BBarang3'>
        <form id='belit3' name='belit3' method='post' action='' >
            <input type='submit' name='BeliConsole Game3' id='BeliConsole Game3' value='Beli' />
        </form></div>
          
    <div id='BBarang4'>
        <form id='belit4' name='belit4' method='post' action='' >
            <input type='submit' name='BeliConsole Game4' id='BeliConsole Game4' value='Beli' /> </form></div>
    <div id='BBarang5'>
        <form id='belit5' name='belit5' method='post' action='' >
            <input type='submit' name='BeliConsole Game5' id='BeliConsole Game5' value='Beli' /> </form>
    </div>";
	}
?>
</body>
