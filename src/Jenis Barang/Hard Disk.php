...
<div id="SearchBar">
  ...
  <input type="submit" name="T.Search" id="T.Search" value="Cari Barang!" />
	...
	<div id='KBarang'>Hard Disk</div>
    
<?php
	$query = "SELECT `id`, `nama`, `harga`, `stok`, `terjual` FROM `hard disk` ORDER BY `id`";
    ...
    <div id='NBarang$id'><a href='Hard Disk/Hard Disk$id.php'>$nama</a></div>
    <div id='HBarang$id'>Rp$harga</div>
    <div id='BBarang1'>
    <form id='belit1' name='belit1' method='post' action='' >
            <input type='submit' name='BeliHard Disk1' id='BeliHard Disk1' value='Beli' />
      </form>
    </div>
    
    <div id='BBarang2'>
        <form id='belit2' name='belit2' method='post' action='' >
            <input type='submit' name='BeliHard Disk2' id='BeliHard Disk2' value='Beli' />
      </form>
    </div>
    
    <div id='BBarang3'>
        <form id='belit3' name='belit3' method='post' action='' >
            <input type='submit' name='BeliHard Disk3' id='BeliHard Disk3' value='Beli' />
        </form></div>
          
    <div id='BBarang4'>
        <form id='belit4' name='belit4' method='post' action='' >
            <input type='submit' name='BeliHard Disk4' id='BeliHard Disk4' value='Beli' /> </form></div>
    <div id='BBarang5'>
        <form id='belit5' name='belit5' method='post' action='' >
            <input type='submit' name='BeliHard Disk5' id='BeliHard Disk5' value='Beli' /> </form>
    </div>";
	}
?>
</body>
