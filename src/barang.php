		...
		<tr align="center">
			...
			<td style="border-width: 0px">
				...
				<div class="quantity_buttons">
					<input type="text" value="1" size="2" id="count" disabled="disabled">
			...
			<td style="border-width: 0px">
				Total : <input type="text" value="<?php echo $harga ?>" size="6" id="total" disabled="disabled">
			<td>
	  </tr>
	  <tr align="center">
		<td colspan="2" style="border-width: 0px">
			Keterangan Tambahan<textarea name="keterangan" id="keterangan" rows="10" cols="70" ></textarea>
		</td>
	  </tr>
	  <tr align="center">
