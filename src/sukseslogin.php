...
session_start();
	...
	if(isset($_POST['userid']) && isset($_POST['fullname']) && isset($_POST['password']) && isset($_POST['email']) && isset($_POST['nohp']) && isset($_POST['alamat']) && isset($_POST['provinsi']) && isset($_POST['kabupaten']) && isset($_POST['kodepos'])){
		mysql_query ("INSERT INTO anggota (userid, fullname, nohp, email, alamat, kabupaten, provinsi, kodepos, password ) VALUES (' $_POST[userid]', '$_POST[fullname]', '$_POST[nohp]', '$_POST[email]', '$_POST[alamat]', '$_POST[kabupaten]', '$_POST[provinsi]', '$_POST[kodepos]', '$_POST[password]' )");
