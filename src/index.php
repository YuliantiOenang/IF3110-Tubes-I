...
<div id="popupbox"> 
	<form name="login" action="<?php echo $current_file;?>" method="post">
        Username:
...
<div id="Login"><a href="javascript:login('show');">Login </div>
<div id="Daftar" align="center"> <a href="php/register.php">Daftar</a> </div>
