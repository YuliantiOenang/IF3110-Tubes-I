...
<head>
	...
	<div id="divsearch" >
		<form id="formuser" name="formsearch" action="searchbarang.php" method="get" tag="registrasi">
			<span id="tabuser">
				...
				?>
					...
					<a href="profil.php" style="text-decoration:none;"> <span id="menuuser3" > <b>PROFIL  &nbsp; &nbsp;  </b> </span> </a>  &nbsp; &nbsp; 
					<span> <a href="shoppingcart.php" style="text-decoration:none;" ><img id="logotroli" src="images/cartlogo.png" height="22" width="22" > </span> &nbsp;
					<span id="cartmenu" > <b>Produk :  <?php if(isset($_SESSION['cart'])) echo get_jum_cart(); else echo 0;?>  </b> </span> 
					<span id="cartmenu" > &nbsp; <b>Rp <?php if(isset($_SESSION['cart'])) echo get_order_total(); else echo 0; ?> ,- </b> </span> 
				<?php endif ?>
		...
		<form id="formsearch" name="formsearch" action="searchbarang.php" method="get" tag="registrasi">
			<a href="index.php"> <img id="logo" src="images/logo10.gif" height="60" width=auto > <br/>  <br/>
			<span id="tabkategori">
			<a href="product.php?nama=beras" style="text-decoration:none;" > <span id="menukategori1" > <b>BERAS &nbsp; &nbsp;  |</b> </span> </a> &nbsp; &nbsp; 
			<a href="product.php?nama=roti" style="text-decoration:none;"> <span id="menukategori2" > <b>ROTI  &nbsp; &nbsp;  | </b> </span> </a>  &nbsp; &nbsp;
			<a href="product.php?nama=daging segar" style="text-decoration:none;"> <span id="menukategori3" > <b>DAGING SEGAR   &nbsp; &nbsp;  |</b> </span> </a>  &nbsp; &nbsp; 
			<a href="product.php?nama=daging olahan" style="text-decoration:none;"> <span id="menukategori4" > <b>DAGING OLAHAN  &nbsp; &nbsp;  |</b> </span> </a>  &nbsp; &nbsp; 
			<a href="product.php?nama=sayur" style="text-decoration:none;"> <span id="menukategori5" > <b>SAYUR  &nbsp; &nbsp;  |</b> </span> </a>  &nbsp; &nbsp; 
			<a href="product.php?nama=buah" style="text-decoration:none;"> <span id="menukategori6" > <b>BUAH </b> </span> </a>  &nbsp; &nbsp;
			</span> </br><br/>
