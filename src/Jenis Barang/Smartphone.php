...
<div id="SearchBar">
  ...
  <input type="submit" name="T.Search" id="T.Search" value="Cari Barang!" />
	...
	<div id='KBarang'>Smartphone</div>
    
<?php
	$query = "SELECT `id`, `nama`, `harga`, `stok`, `terjual` FROM `smartphone` ORDER BY `id`";
    ...
    <div id='NBarang$id'><a href='Smartphone/Smartphone$id.php'>$nama</a></div>
    ...
    <div id='BBarang2'>
        <form id='belit2' name='belit2' method='post' action='' >
            <input type='submit' name='BeliSmartphone2' id='BeliSmartphone2' value='Beli' />
      </form>
    </div>
    ...
    <div id='BBarang4'>
        <form id='belit4' name='belit4' method='post' action='' >
            <input type='submit' name='BeliSmartphone4' id='BeliSmartphone4' value='Beli' /> </form></div>
    <div id='BBarang5'>
        <form id='belit5' name='belit5' method='post' action='' >
            <input type='submit' name='BeliSmartphone5' id='BeliSmartphone5' value='Beli' /> </form>
    </div>";
	}
?>
</body>
