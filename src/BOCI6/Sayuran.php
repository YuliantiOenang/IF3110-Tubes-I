...
<body>
	...
	<div id="container">
		...
		<div id="sort-bar" class="frame">
			...
			<button type="button" onClick="location.href='Sayuran.php?SortBy=Nama'">Nama</button>
			<button type="button" onClick="location.href='Sayuran.php?SortBy=Harga'">Harga</button>
		</div>
