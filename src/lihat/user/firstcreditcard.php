...
<body>
	...
	<div class="basiccontent" id="addcreditcardcontent">
		<form id="creditCardForm" action="#" method="POST" onsubmit="onCreditCardCreate('<?=SITE_ROOT.NAME_ROOT;?>/user/firstcreditcard'); return false;">
			...
			<input type="button" value="skip" onClick="window.location='<?=SITE_ROOT.NAME_ROOT;?>/user';"><br>
			* = Wajib diisi
		</form>
		<script src="<?=SITE_ROOT.NAME_ROOT;?>/js/date.js" type="text/javascript"></script>
	</div>
</body>
</html>
