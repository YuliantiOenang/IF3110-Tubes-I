...
<html lang="en">
  ...
  <body>
  		...
  		<div class ="header" id="headerother">
  		        <a href="index.php" title="RuSerBa" target="blank">
			...
			<div class="content-area">
				 ...
				 <br>
				 <h3>Description</h3>
				 <p>The Wasp Class Missile is a very powerful but light missile. The wasp missile is the first choice of small fighter craft. It is fast, accurate and very deadly. It's lethal reputation has even led it to be fitted to some destroyers. If fired in masses, the high speed makes it nearly impossible for a weapon system to defend against all incoming missiles.</p> 
				 <br>
				 Stats
				 <br>
				 <div>Speed: 560 m/s,
				...
				On reserve: 500
				<br>
				Purchase quantity: <input type="text" name="q" size="5" maxlength="3">
				<br>
