...
<title>Acer Aspire m5-583p</title>
...
<div id="NBarang">Acer Aspire m5-583p</div>
<div id="GBarang"><img src="../../image/Acer Aspire M5-583P.png" width="324" height="210" /></div>
<div id="InfoBarang">
  <p>OS: Windows 8 Home<br />
    </p>
  <p>Dimensi: 15 x 10.1 x 0.7 inch<br />
    </p>
  <p>Berat: 4.9 pounds<br />
    </p>
  <p>Ukuran Layar: 1366 x 768 pixels; 15.6 inch<br />
    </p>
  <p>Processor Intel Core i5-4200U 1.6 GHz<br />
    </p>
  <p>Graphic Processor: Intel HD Graphic 4400<br />
    </p>
  <p>RAM: 8 GB DDR3<br />
    </p>
  <p>Storage: 500 GB<br />
...
<form id="belin5" name="belin5" method="post" action="" >
		<input type="submit" name="BeliNotebook5" id="BeliNotebook5" value="Beli" />
  </form>
</div>
</body>
</html>
