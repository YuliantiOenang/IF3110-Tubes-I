...
function validateUsername() {
	...
	var serverAddress = "validation.php";
...
function validateLogin() {
	// holds the remote server address
	var serverAddress = "validatelogin.php";
	// when set to true, display detailed error messages
	var showErrors = true;
...
function login() {
	openlogin = window.open("login.php", "loginWindow", "width=800, height=400, status=no, toolbar=no, menubar=no");
