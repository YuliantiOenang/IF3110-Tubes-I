  ...
  <body>
  		...
  		<div class ="header" id="headerother">
			...
			<div class = "content-area">
				 <h1>Silkworm Missile</h1>
				 <img src="image/item1.jpg"/>
				 <br>
				 <h3>Description</h3>
				 <p>The Silkworm Missile combines the quantum technology with a warhead able to destroy even heavily protected targets. This missile will be typically used for attacks on large fighers or transports.</p> 
				 <br>
				 Stats
				 <br>
				 <div>Speed: 190 m/s,
				 <br>Lifetime: 150 secs,
				 <br>Damage: 19,000,
				 <br>Radius: 20m,
				 <br><p>Price: 5k credits,
				 <br>Range: 28.5km,
				 <br>Warhead: Single,
				 <br>Tracking: Yes,</div>
  				<br>
