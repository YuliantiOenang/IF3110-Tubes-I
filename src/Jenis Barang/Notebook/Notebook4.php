...
<div id="NBarang">Alienware 17</div>
<div id="GBarang"><img src="../../image/Alienware 17.png" width="276" height="210" /></div>
<div id="InfoBarang">
  <p>OS: Windows 7, Windows 8<br />
    </p>
  <p>Dimensi: 16.28 x 11.77 x 1.91 inch<br />
    </p>
  <p>Berat: 9,15 pounds<br />
    </p>
  <p>Ukuran Layar: 1920 x 1080 pixels; 17.3 inch<br />
    </p>
  <p>Processor: Intel Core i7-4700MQ 2.4 GHz<br />
    </p>
  <p>VGA: Nvidia GeForce GTX 765M 2GB<br />
    </p>
  <p>RAM: 8GB DDR3<br />
    </p>
  <p>Storage: 750 GB<br />
...
<form id="belin4" name="belin4" method="post" action="" >
		<input type="submit" name="BeliNotebook4" id="BeliNotebook4" value="Beli" />
  </form>
  </div>
</body>
</html>
